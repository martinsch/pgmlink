...
BOOST_AUTO_TEST_CASE( uncertaintyWithGumbel ) {
...
BOOST_AUTO_TEST_CASE( diverseUncertainty ) {
	...
	n21.Id = 21; n21.Timestep = 2; com[0] = 2; com[1] = 2; com[2] = 3; divProb[0] = 0.5; detProb[0] = 0.1;detProb[1]=0.9;
	n21.features["com"] = com; n21.features["divProb"] = divProb; n21.features["detProb"] = detProb;
	add(ts,n21);
	...
	for(size_t timeStep=0;timeStep<events[0].size();++timeStep){
		for(size_t factorIndex=0;factorIndex<events[0][timeStep].size();++factorIndex){
	...
	//namely divison or move of the cell in the 2. timeStep. So we
