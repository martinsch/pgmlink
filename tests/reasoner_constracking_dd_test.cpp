//#define BOOST_TEST_MODULE reasoner_constracking_dd_test
...
//BOOST_AUTO_TEST_CASE( Tracking_ConservationTrackingDD_Merger ) {
...
//            BOOST_CHECK_NE(e.type, Event::Division);
            assert(e.type != Event::Disappearance);
            assert(e.type != Event::Appearance);
            assert(e.type != Event::Division);
...
//BOOST_AUTO_TEST_CASE( Tracking_ConservationTrackingDD_SimpleMove ) {
...
//BOOST_AUTO_TEST_CASE( Tracking_ConservationTrackingDD_Merger_Volume ) {
...
//BOOST_AUTO_TEST_CASE( Tracking_ConservationTrackingDD_Disappearance ) {
...
//BOOST_AUTO_TEST_CASE( Tracking_ConservationTrackingDD_AppearanceAndDisappearance ) {
...
//BOOST_AUTO_TEST_CASE( Tracking_ConservationTrackingDD_Appearance ) {
...
//BOOST_AUTO_TEST_CASE( Tracking_ConservationTrackingDD_AppearanceSimple ) {
...
//BOOST_AUTO_TEST_CASE( Tracking_ConservationTrackingDD_TranslationVector_Traxels ) {
...
//BOOST_AUTO_TEST_CASE( Tracking_ConservationTrackingDD_TranslationVector_Tracklets ) {
...
//BOOST_AUTO_TEST_CASE( Tracking_ConservationTrackingDD_Merger4 ) {
...
//BOOST_AUTO_TEST_CASE( Tracking_ConservationTrackingDD_MergerResolvingDivision ) {
...
//BOOST_AUTO_TEST_CASE( Tracking_ConservationTrackingDD_TranslationVector2 ) {
