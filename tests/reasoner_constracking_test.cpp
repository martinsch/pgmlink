...
BOOST_AUTO_TEST_CASE( Tracking_ConservationTracking_Appearance ) {
	...
	BOOST_CHECK_EQUAL(num_events, 11);
	BOOST_CHECK_EQUAL(moves,7);
	BOOST_CHECK_EQUAL(apps,2);
	BOOST_CHECK_EQUAL(mergers,2); // the merger in the last time frame will be detected but not stored in the events vector
}
