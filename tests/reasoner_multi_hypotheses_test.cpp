...
BOOST_AUTO_TEST_CASE( MultiHypothesesGraph_restrict_in_time2 ) {
  ...
  std::fill(com.begin(), com.end(), 0);
  t3.rbegin()->features["conflicts"] = feature_array(0);
  t3.rbegin()->features["level"].push_back(0.);
  t3.rbegin()->features["com"] = com;
  t3.rbegin()->features["count_prediction"] = count;
  ...
  std::fill(com.begin(), com.end(), 0);
  t4.rbegin()->features["conflicts"] = feature_array(0);
  t4.rbegin()->features["level"].push_back(0.);
  t4.rbegin()->features["com"] = com;
  t4.rbegin()->features["count_prediction"] = count;
